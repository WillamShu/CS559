...
window.onload = function() {
    ...
    function draw() {
        ...
        var projM = twgl.m4.perspective(fov, 1, 0.1, 1000000);
        var cameraM = twgl.m4.lookAt(lookFrom,lookAt,[0,1,0]);
        var viewM = twgl.m4.inverse(cameraM);

        // Transforms for the shadow map
        var shadowCameraM = twgl.m4.lookAt([],lookAt,[0,1,0]);
        var shadowViewM = twgl.m4.inverse(cameraM);
