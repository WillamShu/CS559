...
(function () {
    ...
    var skybox_posx = LoadedImageFiles["posx.jpg"];
    var skybox_negx = LoadedImageFiles["negx.jpg"];
    var skybox_posz = LoadedImageFiles["posz.jpg"];
    var skybox_negz = LoadedImageFiles["negz.jpg"];
    var skybox_posy = LoadedImageFiles["posy.jpg"];
    var skybox_negy = LoadedImageFiles["negy.jpg"];
