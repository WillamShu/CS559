...
(function () {
        ...
        if (!copterBodyBuffers) {
            var arrays = {
                ...
                vnormal : {numComponents:3, data: [
                    2,0,0,  0,0,2,  -2,0,0,  0,0,-2, 0,2,0,  0,-2	,0,
    ...
    Copter.prototype.draw = function(drawingState) {
        ...
        modelM = twgl.m4.multiply(twgl.m4.scaling([.5, .5, .5]), modelM);
        ...
        modelM = twgl.m4.multiply(twgl.m4.rotationY(drawingState.realtime/50), modelM);
        ...
        switch (heli.state) {
            ...
            case 1: // taking off
                if (heli.position[1] < altitude) {
                    ...
                    var dest = randomHelipad(heli.lastPad, 0.5);
                    heli.lastPad = dest;
...
grobjects.push(new Helipad([3,.01,3], 0.5));
grobjects.push(new Helipad([4,3.01,-3],1.0));
grobjects.push(new Helipad([-4,1.51,-3],0.5));
grobjects.push(new Helipad([-3,.01,3],0.5));
