...
(function() {
    ...
    function genGround(size) {
        var i, j;
        var vertex = [];
        for (i = -groundPlaneSize; i < groundPlaneSize; i += size) {
            for (j = -groundPlaneSize; j < groundPlaneSize; j += size) {
                vertex = vertex.concat([i, 0, j,
                                  i+size, 0, j,
                                  i, 0, j+size,
                                  i+size, 0, j,
                                  i, 0, j+size,
    ...
    var ground = {
        ...
        init : function(drawingState) {
            ...
            var arrays = { vpos : {numComponents:3, data:genGround(1)} };
        ...
        draw : function(drawingState) {
            ...
            twgl.setUniforms(shaderProgram,{
                ...
                spotlightPos:drawingState.spotlightPos
            });
